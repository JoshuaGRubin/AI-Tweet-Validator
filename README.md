...
- If you've created a Twitter developer account and you'd like to download new conent, uncomment the appropriate four rows in `build\Dockerfile` and paste in your credentials.
...
While this setup has a few more steps and is potentially less portable, there's much less to download and store on disk.
